...
//    AUDIO_SAMPLE_RATE_TEST = TEST_MODE_SAMPLE_RATE,      /* test mode sample rate */    
}AUDIO_SAMPLE_RATE_E;
...
typedef enum tagAudioCodecType
{
    AUDIO_EXTERNAL_CODEC = 0,
...
//    AUDIO_SAMPLE_RATE_E enSampleRate;       /* audio sampleing rate */
