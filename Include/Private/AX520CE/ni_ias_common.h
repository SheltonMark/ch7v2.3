...
// 版本号信息
#define IAS_API_VERSION      (10105)
#define IAS_COMMON_VERSION   (10000)
#define IAS_ALG_UNIT_VERSION (10000)
#define XS_AI_VERSION        (10000)
...
typedef enum tagIasObjType {
    ...
    IAS_OBJ_TYPE_GES_LIKE    = 13,
    IAS_OBJ_TYPE_GES_STOP    = 14,
    IAS_OBJ_TYPE_FIRE        = 15,
    IAS_OBJ_TYPE_SMOKE       = 16,
    IAS_OBJ_TYPE_HELMET      = 17,
    IAS_OBJ_TYPE_BODY_FALL   = 18,
    IAS_OBJ_TYPE_BUTT,
} IAS_OBJ_TYPE_E;
...
typedef enum tagPerimeterRuleType {
    ...
    IAS_PERIMETER_RULE_POLYGON_WANDER  = 2, /*区域徘徊*/
    IAS_PERIMETER_RULE_POLYGON_FENCE   = 3, /*虚拟围栏*/
    IAS_PERIMETER_RULE_POLYGON_ABSENCE = 4, /*区域离岗*/
    IAS_PERIMETER_RULE_POLYGON_COUNT   = 5, /*区域人数*/
    IAS_PERIMETER_RULE_POLYGON_INOUT   = 6, /*区域出入*/
...
typedef struct tagIasPerimeterRule {
    ...
    union {
        IAS_PERIMETER_RULE_POLYLINE_S stPolyline;      /* UNION:enType=IAS_PERIMETER_RULE_POLYLINE        | PG 周界规则配置 */
        IAS_PERIMETER_RULE_POLYGON_S  stPolygon;       /* UNION:enType=IAS_PERIMETER_RULE_POLYGON         | PG 周界规则配置 */
        IAS_PERIMETER_RULE_POLYGON_S  stPolygonWander; /* UNION:enType=IAS_PERIMETER_RULE_POLYGON_WANDER  | PG 周界规则配置 */
        IAS_PERIMETER_RULE_POLYGON_S  stPolygonFence;  /* UNION:enType=IAS_PERIMETER_RULE_POLYGON_FENCE   | PG 周界规则配置 */
    };
