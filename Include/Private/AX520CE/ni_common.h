...
#ifndef CODE_TIME
#define CODE_TIME "unknown"
#endif

/* 优先使用模块层级版本 */
#ifdef MOD_CODE_VERSION
#define EMBED_CODE_VERSION MOD_CODE_VERSION
#else
#define EMBED_CODE_VERSION CODE_VERSION
#endif

#ifdef MOD_CODE_TIME
#define EMBED_CODE_TIME MOD_CODE_TIME
#else
#define EMBED_CODE_TIME CODE_TIME
#endif
...
#define __MK_CODE_VERSION(q)     "code:" #q
#define MK_CODE_VERSION(q)       __MK_CODE_VERSION(q)
#define __MK_VERSION(x, y, z, p) #x "." #y "." #z "." #p " "
#define MK_VERSION(x, y, z, p)   __MK_VERSION(x, y, z, p)
#define MDK_VERSION                                                   \
    "[" CHIP_NAME MDK_VER_PRIX MK_VERSION(VER_X, VER_Y, VER_P, VER_Z) \
    VER_B                      VER_D "], " MK_CODE_VERSION(EMBED_CODE_VERSION)

#define MDK_CODE_TIME "commit:[" EMBED_CODE_TIME "]"
...
#define MDK_MOD_AISP   "AISP"

#define MDK_MOD_PM  "PM"
#define MDK_MOD_SLP "slpstat"
