...
CFLAGS   += -I$(TOPDIR)/Build/AX_520CE/
...
ifeq ($(cpu), XS7302)
	CFLAGS  += -I$(TOPDIR)/Include/Private/AX520CE/
	CFLAGS  += -I$(TOPDIR)/Include/Private/AX520CE/aisp_tune_inc/
...
ifeq ($(cpu), AX520CE)
	...
	CFLAGS  += -I$(TOPDIR)/Src/video/          # 视频模块头文件
